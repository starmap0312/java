...
// 1) it provides a very convenient API for extracting and manipulating data
//    it uses DOM, CSS, and jquery-like methods
...
public class JSoup {
    ...
    public static void main(String[] args) {
        // 1) parse(): parse HTML from a string
        String html = "<html>"
